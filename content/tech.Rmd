...
It is also possible to include Python code chunks in R Markdown, by first loading `reticulate` package (in R):
...
reticulate::conda_install(packages = c("python","matplotlib"), forge = TRUE)
```
